...
module.exports = function (Model) {
  ...
  Model.beforeRemote('**', function configureModel(ctx, instance, next) {
    ...
    console.log("Tenant:Model.beforeRemote:accessToken,tenant", accessToken, tenant);
    ...
    if (accessToken && accessToken.userId && accessToken.realm === ctx.req.params.tenant) {
      console.log("Tenant:Model.beforeRemote:accessToken,tenant,req.body", accessToken, ctx.req.params.tenant, ctx.req.body);
